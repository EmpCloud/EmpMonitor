...
<head>
    ...
    <title>@if((new App\Modules\User\helper)->checkHost() )
        {{env('WEBSITE_TITLE')}} | @endif SignIn
    </title>
...
<body>
    ...
    <div class="page-container">
        <div class="login">
            <div class="login-bg">
                <div>
                    <img src="https://app.empmonitor.com/assets/images/logos/white-logo.png" class="white-logo">
                </div>
                    ...
                    <div class="logIn-content">
                        ...
                        <div class="login-body">
                            <form id="login-form" action="login" method="POST">
                                ...
                                <div class="button-wrap">
                                    <div class="custom-control custom-checkbox form-group">
                                        <input
                                            ...
                                            id="exampleCheck1" />
                                        <label id="CustomCheckBox1" class="custom-control-label" for="exampleCheck1">Remember password</label>
                                    </div>
                                    <a class="float-right forget-pswd-link" href="#" data-toggle="modal" data-target="#forgotPasswdModal">Forgot password?</a>
                                ...
                                <p class="m-t-sm">
                                    <a class="float-right" href="/" id="AdminLoginBtn">Admin Login?</a>
                                </p>
                            </form>
